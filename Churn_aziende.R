...
# il periodo di holdout va dal 2019-02-01 al 2019-04-30.
...
#abbiamo un problema di classi sbilanciate
...
#per capire il modello migliore consideriamo le metrice: precisions, recall, recall, F1-score, AUC and lift.
