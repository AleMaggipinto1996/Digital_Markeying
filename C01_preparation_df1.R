...
df1_p_codfid_main #L'ultima tessera fedeltà attivata dai clienti nel 98.4% dei casi
#è una tessera principale (328388 casi), mentre nell'1.6% dei casi
#(5246 casi) abbiamo che la tessera attivata è secondaria
